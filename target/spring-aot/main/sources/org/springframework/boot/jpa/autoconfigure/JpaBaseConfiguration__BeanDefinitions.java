...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("miguel.Entidad.EntidadAlumno", "miguel.Entidad.EntidadAlumnoTaller", "miguel.Entidad.EntidadCarrera", "miguel.Entidad.EntidadCurso", "miguel.Entidad.EntidadDatosPersonales", "miguel.Entidad.EntidadEscuela", "miguel.Entidad.EntidadMateria", "miguel.Entidad.EntidadProfesor", "miguel.Entidad.EntidadSistemaEscolar", "miguel.Entidad.EntidadTaller", "miguel.Llaves.LlaveCompuestaTallerAlumno");
