...
/**
 * Bean definitions for {@link EscuelaRepositorio}.
 */
@Generated
public class EscuelaRepositorio__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'escuelaRepositorio'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getEscuelaRepositorioInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'escuelaRepositorio'.
   */
  public static BeanDefinition getEscuelaRepositorioBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, EscuelaRepositorio.class, EntidadEscuela.class, UUID.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "miguel.Repositorio.EscuelaRepositorio");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.EscuelaRepositorio.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new miguel.Repositorio.EscuelaRepositorioImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getEscuelaRepositorioInstanceSupplier();
