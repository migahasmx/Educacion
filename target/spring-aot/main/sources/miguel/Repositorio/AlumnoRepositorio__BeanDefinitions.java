...
/**
 * Bean definitions for {@link AlumnoRepositorio}.
 */
@Generated
public class AlumnoRepositorio__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'alumnoRepositorio'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getAlumnoRepositorioInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'alumnoRepositorio'.
   */
  public static BeanDefinition getAlumnoRepositorioBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, AlumnoRepositorio.class, EntidadAlumno.class, UUID.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "miguel.Repositorio.AlumnoRepositorio");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.AlumnoRepositorio.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new miguel.Repositorio.AlumnoRepositorioImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getAlumnoRepositorioInstanceSupplier();
